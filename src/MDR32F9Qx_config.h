/* MDR32F9Qx Standard Peripherals Library configuration file.
 *
 * MDR32F9Qx Standard Peripherals Library is a package consisting of all
 * standard peripheral device drivers for 1986BE9x, K1986BE9x, MDR32F9Qx and
 * 1986VE1T microcontrollers. This library is a firmware package which contains
 * a collection of routines, data structures and macros covering the features of
 * Milandr MDR32F9Qx peripherals. It includes a description of the device
 * drivers plus a set of examples for each peripheral. The firmware library
 * allows any device to be used in the user application without the need for
 * in-depth study of each peripherals specifications. Using the Standard
 * Peripherals Library has two advantages: it saves significant time that would
 ...
 * 1986BE9x evaluation boards and Milandr evaluation board for MC 1986VE1T (EVAL * 22.0 B).
 *
